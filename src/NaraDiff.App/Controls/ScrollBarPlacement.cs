...
/// by swapping which Grid column each part occupies in the ScrollVeiwer's own template (see
/// Shared.xaml), rather than mirroring the control with FlowDirection.RightToLeft: that trick also
/// flips the coordiante space a stylus reports through GetPosition, which reverses the direction of
